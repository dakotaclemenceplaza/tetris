...
var _user$project$Types$Key = function (a) {
	return {ctor: 'Key', _0: a};
};
var _user$project$Types$RandomRot = function (a) {
	return {ctor: 'RandomRot', _0: a};
};
var _user$project$Types$RandomFig = function (a) {
	return {ctor: 'RandomFig', _0: a};
};
																						...
																						_1: {
																							...
																							_1: {
																								...
																								_1: {
																									...
																									_1: {
																										ctor: '::',
																										_0: {ctor: '_Tuple2', _0: 0, _1: 16},
																										_1: {
																											ctor: '::',
																											_0: {ctor: '_Tuple2', _0: 0, _1: 17},
																											_1: {
																												ctor: '::',
																												_0: {ctor: '_Tuple2', _0: 0, _1: 18},
																												_1: {
																													ctor: '::',
																													_0: {ctor: '_Tuple2', _0: 0, _1: 19},
																													_1: {
																														ctor: '::',
																														...
																														_1: {
																															...
																															_1: {
																																...
																																_1: {
																																	ctor: '::',
																																	_0: {ctor: '_Tuple2', _0: 11, _1: 3},
																																	_1: {
																																		ctor: '::',
																																		_0: {ctor: '_Tuple2', _0: 11, _1: 4},
																																		_1: {
																																			ctor: '::',
																																									...
																																									_1: {
																																										...
																																										_1: {
																																											...
																																											_1: {
																																												...
																																												_1: {
																																													ctor: '::',
																																													_0: {ctor: '_Tuple2', _0: 11, _1: 15},
																																													_1: {
																																														ctor: '::',
																																														_0: {ctor: '_Tuple2', _0: 11, _1: 16},
																																														_1: {
																																															ctor: '::',
																																															...
																																															_1: {
																																																...
																																																_1: {
																																																	ctor: '::',
																																																	_0: {ctor: '_Tuple2', _0: 11, _1: 19},
																																																	_1: {
																																																		ctor: '::',
																																																		_0: {ctor: '_Tuple2', _0: 11, _1: 20},
																																																		_1: {ctor: '[]'}
																																																	}
																																																}
																																															}
...
var _user$project$Display$tdList = {
	ctor: '::',
	_0: 1,
	_1: {
		ctor: '::',
...
var _user$project$Display$trList = {
	ctor: '::',
	_0: 20,
	_1: {
		ctor: '::',
...
var _user$project$Display$makeCell = F3(
	function (pos, row, col) {
		return A2(
			_elm_lang$core$List$any,
			function (_p0) {
				var _p1 = _p0;
				return _elm_lang$core$Native_Utils.eq(_p1._1, row) && _elm_lang$core$Native_Utils.eq(_p1._0, col);
			},
			pos) ? A2(
			_elm_lang$html$Html$td,
			{
				...
				_0: _elm_lang$html$Html_Attributes$style(
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'background-color', _1: '#a6a6a6'},
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
...
var _user$project$Display$makeRows = F2(
	function (pos, row) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Display$makeCell, pos, row),
				_user$project$Display$tdList));
	});
var _user$project$Display$mainDisplay = F2(
	function (position, pile) {
		var pos = A2(
			...
			A2(
				...
				function (_p2) {
					var _p3 = _p2;
					return !_elm_lang$core$Native_Utils.eq(_p3._1, 0);
				},
				pile));
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$Display$makeRows(pos),
				_user$project$Display$trList));
	});

var _user$project$Figures$randomFigure = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
...
var _user$project$Update$updateScore = F2(
	function (score, level) {
		return _elm_lang$core$Native_Utils.eq(score, 0) ? (score + (40 * level)) : (_elm_lang$core$Native_Utils.eq(score, 40 * level) ? (score + (60 * level)) : (_elm_lang$core$Native_Utils.eq(score, 100 * level) ? (score + (200 * level)) : (score + (900 * level))));
	});
var _user$project$Update$destroy = F2(
	function (pile, col) {
		if (_elm_lang$core$Native_Utils.cmp(col, 11) > 0) {
			return pile;
		} else {
			var _p0 = A2(
				...
				function (_p1) {
					var _p2 = _p1;
					return _elm_lang$core$Native_Utils.eq(_p2._0, col);
				},
				pile);
			var column = _p0._0;
			var other = _p0._1;
			return ((_elm_lang$core$Native_Utils.cmp(col, 0) > 0) && (_elm_lang$core$Native_Utils.cmp(col, 11) < 0)) ? A2(
				_elm_lang$core$Basics_ops['++'],
				A2(
							...
							A2(
								...
								F2(
									function (_p4, _p3) {
										var _p5 = _p4;
										var _p6 = _p3;
										return A2(_elm_lang$core$Basics$compare, _p5._1, _p6._1);
									}),
								column)))),
				A2(_user$project$Update$destroy, other, col + 1)) : A2(
				_elm_lang$core$Basics_ops['++'],
				column,
				A2(_user$project$Update$destroy, other, col + 1));
		}
	});
				...
				if (_elm_lang$core$Native_Utils.eq(
					_elm_lang$core$List$length(
						A2(
							...
							function (_p7) {
								var _p8 = _p7;
								return _elm_lang$core$Native_Utils.eq(_p8._1, currentRow);
							},
							pile)),
					12)) {
					var _v4 = A2(_user$project$Update$destroy, pile, 0),
						_v5 = currentRow,
...
var _user$project$Update$notPile = F2(
	function (pile, pos) {
		return A2(
			...
			function (_p9) {
				...
				return A2(
					...
					function (_p11) {
						var _p12 = _p11;
						return (!_elm_lang$core$Native_Utils.eq(_p12._0, _p10._0)) || (!_elm_lang$core$Native_Utils.eq(_p12._1, _p10._1));
					},
					pile);
			},
			pos) ? _elm_lang$core$Maybe$Just(pos) : _elm_lang$core$Maybe$Nothing;
	});
var _user$project$Update$upd = function (model) {
	var _p13 = model.position;
	var col = _p13._0;
	var row = _p13._1;
	var rotation = A2(_elm_lang$core$Dict$get, model.rotation, model.figure);
	return A2(
		...
		A2(
			_elm_lang$core$Maybe$andThen,
			_user$project$Update$notPile(model.pile),
			A2(
				_elm_lang$core$Maybe$map,
				_elm_lang$core$List$map(
					function (_p14) {
						var _p15 = _p14;
						return {ctor: '_Tuple2', _0: col + _p15._0, _1: row + _p15._1};
					}),
				rotation)));
};
...
var _user$project$Main$view = function (_p0) {
	...
	var rightArr = A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$id('rarr'),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html_Attributes$property,
					'innerHTML',
					_elm_lang$core$Json_Encode$string('&rarr;')),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
		...
		_elm_lang$html$Html$span,
		{
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html_Attributes$property,
					'innerHTML',
					_elm_lang$core$Json_Encode$string('&larr;')),
				_1: {ctor: '[]'}
			}
		},
		{ctor: '[]'});
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Tetris'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: (!_p3) ? A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('starting'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$id('gameInfo'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
									...
									},
									{
										...
										_0: _elm_lang$html$Html$text(
											A2(
												_elm_lang$core$Basics_ops['++'],
												'Level: ',
												_elm_lang$core$Basics$toString(_p1.level))),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: A2(_user$project$Display$mainDisplay, _p1.currentPos, _p1.pile),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('rotate'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('elm'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Written in '),
												_1: {
													ctor: '::',
													_0: A2(
							...
							_0: A2(
								...
								_user$project$Update$upd(
									_elm_lang$core$Native_Utils.update(
										model,
										{
											position: {ctor: '_Tuple2', _0: col - 1, _1: row}
										}))),
							_1: _elm_lang$core$Platform_Cmd$none
						} : {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
					case 39:
...
var _user$project$Main$model = {
	figure: _elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
